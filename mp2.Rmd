...
The graph above shows the amount of contributions made to the Democratic and Republican parties in District 9 for the election cycle. The x-axis demonstrates the party affiliation and the y-axis represents the total amount of contributions made. The contributions amount include each individual contribution or expenditure made to a candidate during the election cycle.  The color of the bars depict the proportion of the representatives who are incumbents or not. From this graph, we can get a general idea of which state in District 9 has the highest contributions for their candidates and it also highlights which party is receiving what amount. For example, in FL, republican candidates received more contributions than the democratic candidates. In addition, for both political parties, the candidates were not incumbents, as suggested by the color red.    

We find that Republican candidates who are incumbents received the most general votes in IN and VA whereas Democratic candidates who are incumbents received the most general votes in CA, IL, MA, MI, NJ, NY, OH, TN, TX, and WA. We find that none of the Republican and Democratic candidates who are incumbents received the most contributions. Interestingly enough some states had a mix of incumbency for the Democratic party. We decided not to look at PA since the state only records Republican candidates. From this, we interpret that incumbency for democratic candidates matters in terms of general votes as Democrats tend to receive more votes than Republicans when their candidates are incumbents. However, in the case of contributions, we can deduce that incumbency did not matter and more Republicans received greater contributions within the District 9 states. 

From our analysis, we learned about the political representation of each state in District 9; furthermore, the votes and cumulative amount of monetary contributions made to each political party. We think it is important to understand the voting and funding aspects of any federal election cycle because by studying these characteristics, we can infer how much support each political party received from the public. For further research, it would be interesting to test the effect of incumbency on the amount of contributions and votes received by the political representatives.
